 ...
 * 
 * @see co.edu.campusucc.sd.modelos.Sede
...
public class SedeDAO {
	...
	public Sede findById(java.lang.String id) {
		...
		try {
			Sede instance = (Sede) sessionFactory.getCurrentSession().get("co.edu.campusucc.sd.modelos.Sede", id);
			if (instance == null) {
	...
	public List<Sede> findByExample(Sede instance) {
		logger.log(Level.INFO, "finding Sede instance by example");
		try {
			List<Sede> results = sessionFactory.getCurrentSession().createCriteria("co.edu.campusucc.sd.modelos.Sede")
