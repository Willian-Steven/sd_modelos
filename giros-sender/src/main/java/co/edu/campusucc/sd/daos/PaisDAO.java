 ...
 * 
 * @see co.edu.campusucc.sd.modelos.Pais
...
public class PaisDAO {
	...
	public Pais findById(java.lang.String id) {
		...
		try {
			Pais instance = (Pais) sessionFactory.getCurrentSession().get("co.edu.campusucc.sd.modelos.Pais", id);
			if (instance == null) {
	...
	public List<Pais> findByExample(Pais instance) {
		...
		try {
			List<Pais> results = sessionFactory.getCurrentSession().createCriteria("co.edu.campusucc.sd.modelos.Pais")
