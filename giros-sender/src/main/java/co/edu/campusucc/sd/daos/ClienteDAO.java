 ...
 * 
 * @see co.edu.campusucc.sd.modelos.Cliente
...
public class ClienteDAO {
	...
	public Cliente findById(java.lang.String id) {
		...
		try {
			Cliente instance = (Cliente) sessionFactory.getCurrentSession().get("co.edu.campusucc.sd.modelos.Cliente",
					id);
			if (instance == null) {
	...
	public List<Cliente> findByExample(Cliente instance) {
		...
		try {
			List<Cliente> results = sessionFactory.getCurrentSession().createCriteria("co.edu.campusucc.sd.modelos.Cliente")
