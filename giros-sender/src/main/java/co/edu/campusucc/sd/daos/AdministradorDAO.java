...
import co.edu.campusucc.sd.modelos.Administrador;
...
public class AdministradorDAO {
	...
	public Administrador findById(co.edu.campusucc.sd.modelos.AdministradorId id) {
		...
		try {
			Administrador instance = (Administrador) sessionFactory.getCurrentSession()
					.get("co.edu.campusucc.sd.modelos.Administrador", id);
			if (instance == null) {
	...
	public List<Administrador> findByExample(Administrador instance) {
		...
		try {
			List<Administrador> results = sessionFactory.getCurrentSession()
					.createCriteria("co.edu.campusucc.sd.modelos.Administrador").add(Example.create(instance)).list();
